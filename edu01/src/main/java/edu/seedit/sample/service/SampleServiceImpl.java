...
public class SampleServiceImpl implements SampleService {
	...
	public List<SampleVO> getSampleList(Map<String,Object> in) throws Exception {
		...
		/*if(in.get("pageNo"        ) != null && !in.get("pageNo"        ).equals("")) { eDTO.setPageNo        (in.get("pageNo"        ).toString()); }
		if(in.get("pageSize"      ) != null && !in.get("pageSize"      ).equals("")) { eDTO.setPageSize      (in.get(PAGE_SIZE       ).toString()); }
*/
		List<SampleVO> out = dao.selectSampleList(eDTO);
/*		int totalCnt = sampleService.sampleListCount(eDTO);
...
logger.debug("eDTO:" + eDTO.toString());
	...
	public List<SampleVO> pagingSampleList(SampleVO vo) {
		return dao.pagingSampleList(vo);
	}
	@Override
	public int sampleListCount(SampleVO vo) {
		return dao.sampleListCount(vo);
	}
